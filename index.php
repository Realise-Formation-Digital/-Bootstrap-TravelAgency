...
?>
                ...
                <form action="/action_page.php">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <button class="btn dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="jour-dropdown" role="button"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="container">
        ...
        <div class="row text-center">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                <a href="#"><img src="assets/img/unique-grindelwald.jpg" alt="Grindelwald"
                        class="card-img-top img-unique"></a>
                <div class="card">
                    <div class="card-body">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                <a href="#"><img src="assets/img/unique-oberland.jpeg" alt="Lauterbrunnen"
                        class="card-img-top img-unique"></a>
                <div class="card">
                    <div class="card-body">
